...
const userSchema = new Schema({
    ...
    username: {type: String, minlength: [6, 'Minimum length must be 6 characters'], maxlength: [22, 'username has to be less than 22 characters'], required: [true, 'Need a username'], index: {unique: true}},
